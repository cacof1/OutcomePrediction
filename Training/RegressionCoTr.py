...
tb_logger = pl_loggers.TensorBoardLogger(save_dir='lightning_logs', name='CoTr')
...
dataloader = DataModule(MasterSheet, label, module_dict.keys(), train_transform=train_transform,
                        val_transform=val_transform, batch_size=8, numerical_norm=sc, category_norm=ohe,
                        inference=False)
